  ...
  export default function QqDialog() {
    return (
        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <p>
            Follow us for a free Key daily
            </p>
        </div>
        </DialogContent>
    </Dialog>
